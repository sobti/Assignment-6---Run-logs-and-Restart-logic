				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="<?php echo base_url(); ?>">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo base_url(); ?>/assets/price"> Pricing Plan</a></p>
						</div>											
					</div>
				</div>
			</section>
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-3 feat-img no-padding">
							<img class="img-fluid" src="<?php echo base_url(); ?>/assets/img/pages/f1.jpg" alt="">
						</div>
						...
						<div class="col-lg-3 feat-img no-padding">
							<img class="img-fluid" src="<?php echo base_url(); ?>/assets/img/pages/f2.jpg" alt="">							
						</div>
						<div class="col-lg-3 no-padding feat-txt">
							<h6 class="text-uppercase text-white">Basic & Common Repairs</h6>
							<h1>What we do</h1>
